...
<section class="sliders">
  <div class="container">
    <div class="header-sliderComp">Наши партнеры</div>
    <div class="sliderComp">
      <div>
        <div class="sliderImg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/partners/1.png)"></div>
      </div>
      <div>
        <div class="sliderImg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/partners/2.png)"></div>
      </div>
      <div>
        <div class="sliderImg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/partners/3.png)"></div>
      </div>
      <div>
        <div class="sliderImg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/partners/4.png)"></div>
      </div>
      <div>
        <div class="sliderImg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/partners/5.png)"></div>
      </div>
      <div>
        <div class="sliderImg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/partners/6.png)"></div>
      </div>
      <div>
        <div class="sliderImg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/partners/7.png)"></div>
      </div>
       <div>
        <div class="sliderImg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/partners/8.png)"></div>
      </div>
      <div>
        <div class="sliderImg" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/partners/9.png)"></div>
      </div>
    </div>
  </div> 
</section>
