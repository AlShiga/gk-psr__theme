  ...
  <header class="header container">
      ...
      <div class="logo-wrap">
        ...
        <div class="callMe js-button-campaign-tel">Заказать звонок</div>
            ...
            <div class="logoP"></div>
            <div class="textP">
				      <div class="phone"><a class="phone" onclick=yaCounter52383079.reachGoal('phone') href="tel:<?php echo get_option('site_telephone_back'); ?>"><?php echo get_option('site_telephone'); ?></a></div>
              <div class="phone"><a class="phone" onclick=yaCounter52383079.reachGoal('phone') href="tel:<?php echo get_option('site_telephone_back2'); ?>"><?php echo get_option('site_telephone2'); ?></a></div>
            </div>
          </div>
  		  <div class="mail-wrap">
            <div class="logoM"></div>
